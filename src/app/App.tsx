            ...
            <section className="py-20 bg-white overflow-hidden">
              <div className="max-w-7xl mx-auto px-6 md:px-10">
                <div className="flex flex-col md:flex-row-reverse items-center gap-12 md:gap-16">
                  ...
                  <div
                    ref={focusedImg}
                    className="fade-in w-full md:w-[420px] flex-shrink-0"
                  >
                    <img
                  ...
                  <div className="flex-1 flex flex-col gap-6">
                    ...
                    >
                      La atención de alergias está en alta demanda, pero muchas
                      clínicas enfrentan:
                    </p>
            ...
            <section className="py-20 bg-white">
              <div className="max-w-7xl mx-auto px-8 md:px-12">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  ...
                  <div
                    ref={howImg}
                    className="fade-in from-left relative rounded-3xl overflow-hidden h-[480px]"
                  >
                    <img
                  ...
                  >
                    <div>
                      ...
                      <p
                        ...
                        style={{ color: "var(--brand-muted)" }}
                      >
                        Encuentra el tratamiento que mejor se adapta a tu
                        clínica y tus pacientes.
                      </p>
                    </div>
              ...
              <div className="max-w-7xl mx-auto px-6">
                <div ref={svcTitle} className="fade-in text-center mb-16">
                  ...
                  <p
                    ...
                    style={{ color: "var(--brand-muted)" }}
                  >
                    Todo lo que necesita para ofrecer servicios de alergia de
                    clase mundial
                  </p>
                </div>
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <p
                        ...
                        className="mb-6 leading-relaxed text-white/85"
                      >
                        Pruebas cutáneas y de sangre de última generación para
                        identificar alérgenos específicos con precisión
              ...
              <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-start">
                  ...
                  <div ref={benefitsLeft} className="fade-in from-left">
                    ...
                    >
                      Innovación médica diseñada para transformar la experiencia
                      clínica.
                    </h2>
                    ...
                    <p
                      ...
                      style={{ color: "var(--brand-muted)" }}
                    >
                      Integramos tecnología avanzada, protocolos clínicos
                      modernos y acompañamiento especializado para ayudar a
                      clínicas y hospitales a brindar una atención más
                      eficiente, humana y segura.
                    </p>
                  </div>
                  ...
                  <div
                    ref={benefitsRight}
                    className="fade-in from-right space-y-8"
                  >
                    <div className="border-b border-gray-200 pb-6">
                      ...
                      <p
                        ...
                        style={{ color: "var(--brand-muted)" }}
                      >
                        Creamos experiencias médicas más cercanas y eficientes
                        mediante soluciones diseñadas para mejorar cada etapa
                        del cuidado clínico.
                      </p>
                    </div>
                    ...
                    <div className="border-b border-gray-200 pb-6">
                      ...
                      <p
                        ...
                        style={{ color: "var(--brand-muted)" }}
                      >
                        Utilizamos herramientas y procesos innovadores que
                        permiten diagnósticos más rápidos, mayor precisión
                        clínica y mejores resultados para los pacientes.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p
                        ...
                        style={{ color: "var(--brand-muted)" }}
                      >
                        Ayudamos a las clínicas a expandir sus servicios médicos
                        con modelos escalables, soporte continuo y estrategias
                        enfocadas en crecimiento a largo plazo.
                      </p>
                    </div>
                  </div>
                </div>
